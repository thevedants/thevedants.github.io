...
(()=>{
    ...
    ;
    var Q = (e,t,r)=>(r = e != null ? M_(V_(e)) : {},
    Os(t || !e || !e.__esModule ? Kr(r, "default", {
        value: e,
        enumerable: !0
    }) : r, e))
        ...
        window.tram = function(e) {
            ...
            function u(l, h, y) {
                ...
                l === void 0)
                    return y;
                var T = y;
                return L_.test(l) || !bs.test(l) ? T = parseInt(l, 10) : bs.test(l) && (T = 1e3 * parseFloat(l)),
                0 > T && (T = 0),
                T === T ? T : y
            }
            function f(l) {
            ...
            var g = function(l, h, y) {
                ...
                function V(X, re) {
                    function P() {
                        var ve = new z;
                        return C(ve.init) && ve.init.apply(ve, arguments),
                        ve
                    }
                    function z() {}
                    re === y && (re = X,
                    X = Object),
                    P.Bare = z;
                    var K, se = A[l] = X[l], Ue = z[l] = P[l] = new A;
                    return Ue.constructor = P,
                    P.mixin = function(ve) {
                        return z[l] = P[l] = V(P, ve)[l],
                        P
                    }
                    ,
                    P.open = function(ve) {
                        if (K = {},
                        C(ve) ? K = ve.call(P, Ue, se, P, X) : T(ve) && (K = ve),
                        T(K))
                            for (var sr in K)
                                h.call(K, sr) && (Ue[sr] = K[sr]);
                        return C(Ue.init) || (Ue.init = X),
                        P
                    }
                    ,
                    P.open(re)
            ...
            var ee = t.frame = function() {
              ...
              , ot = g(function(l) {
                function h(B, Y) {
                    ...
                    var ye = _i[Z];
                    if (!ye)
                        return f("Unsupported property: " + Z);
                    if (!Y.weak || !this.props[Z]) {
                        var Le = ye[0]
                          , Ie = this.props[Z];
                        return Ie || (Ie = this.props[Z] = new Le.Bare),
                        Ie.init(this.$el, oe, ye, Y),
                        Ie
                    }
                }
                function y(B, Y, oe) {
                ...
                function se() {
                    ...
                    for (B in this.props)
                        Y = this.props[B],
                        Y.active && oe.push(Y.string);
                    oe = oe.join(","),
                    this.style !== oe && (this.style = oe,
                    this.el.style[q.transition.dom] = oe)
                }
                function Ue(B, Y, oe) {
                    var Z, ye, Le, Ie, zr = Y !== ve, ue = {};
                    for (Z in B)
                        Le = B[Z],
                        Z in at ? (ue.transform || (ue.transform = {}),
                        ue.transform[Z] = Le) : (S.test(Z) && (Z = r(Z)),
                        Z in _i ? ue[Z] = Le : (Ie || (Ie = {}),
                        Ie[Z] = Le));
                    for (Z in ue) {
                        if (Le = ue[Z],
                        ye = this.props[Z],
                ...
                function Ne(B, Y) {
                    l[B] = function() {
                        return this.children ? q_.call(this, Y, arguments) : (this.el && Y.apply(this, arguments),
                        this)
                    }
                }
                function q_(B, Y) {
              ...
              , j = g(function(l) {
                ...
                l.init = function(A, V, X, re) {
                    ...
                    this.ease = y(V[2], this.ease, C.ease),
                    this.delay = u(V[3], this.delay, C.delay),
                    this.span = this.duration + this.delay,
                    this.active = !1,
                    this.nextStyle = null,
                    this.auto = U.test(this.name),
                    this.unit = re.unit || this.unit || Te.defaultUnit,
                    this.angle = re.angle || this.angle || Te.defaultAngle,
                    Te.fallback || re.fallback ? this.animate = this.fallback : (this.animate = this.transition,
                ...
                l.convert = function(A, V) {
                    if (A == "auto" && this.auto)
                        return A;
                    var X, re = typeof A == "number", P = typeof A == "string";
                    switch (V) {
                    case I:
                        if (re)
                            return A;
              ...
              , Wr = g(j, function(l, h) {
                ...
                l.init = function() {
                    ...
                    at.perspective && Te.perspective && (this.current.perspective = Te.perspective,
                ...
                l.values = function(T) {
                    ...
                    return y.call(this, T, function(V, X, re) {
                        A[V] = X,
                        this.current[V] === void 0 && (C = 0,
                        ~V.indexOf("scale") && (C = 1),
                        this.current[V] = this.convert(C, re))
                    }),
                    A
                }
            })
              , ar = g(function(l) {
                ...
                l.init = function(P) {
                    ...
                    se === void 0 && (se = V.to),
                    this.unit = P.unit || "",
                    typeof K == "number" && typeof se == "number" ? (this.begin = K,
                    this.change = se - K) : this.format(se, K),
                ...
                l.render = function(P) {
                    ...
                    if (K < this.duration) {
                        ...
                        return z = this.startRGB ? A(this.startRGB, this.endRGB, se) : C(this.begin + se * this.change),
              ...
              , _s = g(ar, function(l, h) {
                l.init = function(y) {
                    ...
                    for (T in y.values)
                        C = y.values[T],
                        this.current[T] !== C && this.tweens.push(new ar({
                            name: T,
                            from: this.current[T],
                            to: C,
                            duration: y.duration,
                ...
                ,
                l.render = function(y) {
                    var T, C, A = this.tweens.length, V = !1;
                    for (T = A; T--; )
                        C = this.tweens[T],
                        C.context && (C.render(y),
            ...
            q.transform && q.backface && (at.z = [x, "translateZ"],
            at.rotateZ = [F],
            at.scaleZ = [I],
            at.perspective = [R]);
            var L_ = /ms/
        ...
        xs.exports = function() {
            ...
            e.debounce = function(_, N, D) {
                var q, W, H, ee, we, ot = function() {
                    var he = e.now() - ee;
                    he < N ? q = setTimeout(ot, N - he) : (q = null,
                    D || (we = _.apply(H, W),
                    H = W = null))
                };
                return function() {
            ...
            return e.template = function(_, N, D) {
                ...
                _.replace(q, function(he, j, Re, or, Wr) {
                    return H += _.slice(W, Wr).replace(U, k),
                    W = Wr + he.length,
                    j ? H += `'+
...
` + H + "}",
    ...
    var Qe = c((C5,Ms)=>{
        ...
        ;
        function Ns(e) {
            J.env() && (He(e.design) && qe.on("__wf_design", e.design),
            He(e.preview) && qe.on("__wf_preview", e.preview)),
            He(e.destroy) && qe.on("__wf_destroy", e.destroy),
            e.ready && He(e.ready) && k_(e)
        }
        function k_(e) {
            if ($r) {
                e.ready();
        ...
        function Ls(e) {
            He(e.design) && qe.off("__wf_design", e.design),
            He(e.preview) && qe.off("__wf_preview", e.preview),
            He(e.destroy) && qe.off("__wf_destroy", e.destroy),
            e.ready && He(e.ready) && W_(e)
        }
        function W_(e) {
    ...
    var Vs = c((R5,Gs)=>{
        ...
        Ds.define("brand", Gs.exports = function(e) {
            ...
            t.ready = function() {
                ...
                /\.webflow\.io$/i.test(O) && s.hostname !== O && (m = !0),
                m && !a && (f = f || g(),
                d(),
                setTimeout(d, 500),
                e(r).off(u, p).on(u, p))
    ...
    var Us = c((N5,Bs)=>{
        ...
        Si.define("edit", Bs.exports = function(e, t, r) {
            if (r = r || {},
            (Si.env("test") || Si.env("frame")) && !r.fixture && !$_())
                return {
                    exit: 1
                };
            ...
            function E(w, R, x) {
                throw console.error("Could not load editor script: " + R),
                x
            }
            function b(w) {
            ...
            function S(w) {
                ...
                var x = function(F) {
                    F.data === "WF_third_party_cookies_unsupported" ? (I(R, x),
                    w(!1)) : F.data === "WF_third_party_cookies_supported" && (I(R, x),
                    w(!0))
                };
                R.onerror = function() {
                    I(R, x),
    ...
    var Hs = c((L5,Xs)=>{
        ...
        Q_.define("focus-visible", Xs.exports = function() {
            function e(r) {
                ...
                function g(I) {
                    I.metaKey || I.altKey || I.ctrlKey || (a(r.activeElement) && f(r.activeElement),
                    n = !0)
                }
                function d() {
                    n = !1
                ...
                function O(I) {
                    a(I.target) && I.target.hasAttribute("data-wf-focus-visible") && (i = !0,
        ...
        var xi = window.jQuery
          ...
          , Zr = {
            ...
            intro: function(e, t) {
                ...
                xi(t).triggerHandler(ke.types.INTRO))
            },
            outro: function(e, t) {
                t.__wf_intro && (t.__wf_intro = null,
                xi(t).triggerHandler(ke.types.OUTRO))
            }
        };
        ke.triggers = {};
        ke.types = {
    ...
    var en = c((D5,ur)=>{
        ...
        function tT(e, t) {
            if (!t && e && e.__esModule)
                return e;
            if (e === null || eT(e) != "object" && typeof e != "function")
                return {
                    default: e
                };
            var r = tu(t);
    ...
    var qi = c((K5,mu)=>{
        ...
        mu.exports = function(e) {
            if (e == null)
                throw gT("Can't call method on " + e);
            return e
        }
    }
    );
    ...
    var qu = c((tU,Pu)=>{
        var Lu = ie(), Mi = xu(), wu = Lu.process, Cu = Lu.Deno, Ru = wu && wu.versions || Cu && Cu.version, Nu = Ru && Ru.v8, Me, nn;
        Nu && (Me = Nu.split("."),
        nn = Me[0] > 0 && Me[0] < 4 ? 1 : +(Me[0] + Me[1]));
        !nn && Mi && (Me = Mi.match(/Edge\/(\d+)/),
        (!Me || Me[1] >= 74) && (Me = Mi.match(/Chrome\/(\d+)/),
        Me && (nn = +Me[1])));
        Pu.exports = nn
    }
    );
    ...
    var ju = c((uU,Wu)=>{
        ...
        Wu.exports = function(e, t) {
            var r, n;
            if (t === "string" && Ui(r = e.toString) && !Xi(n = Bi(r, e)) || Ui(r = e.valueOf) && !Xi(n = Bi(r, e)) || t !== "string" && Ui(r = e.toString) && !Xi(n = Bi(r, e)))
                return n;
    ...
    var gr = c(Oc=>{
        ...
        Oc.f = RI ? bc : function(t, r, n) {
            ...
            if ("get"in n || "set"in n)
                throw PI("Accessors not supported");
    ...
    var Gc = c((CU,Dc)=>{
        var WI = Cc(), Mc = ie(), eo = Fe(), jI = Rt(), zI = sn(), to = ut(), ro = an(), KI = Ji(), YI = un(), Pc = "Object already initialized", io = Mc.TypeError, $I = Mc.WeakMap, cn, hr, ln, QI = function(e) {
            return ln(e) ? hr(e) : cn(e, {})
        }, ZI = function(e) {
            return function(t) {
                var r;
                if (!jI(t) || (r = hr(t)).type !== e)
                    throw io("Incompatible receiver, " + e + " required");
                return r
            }
        };
        WI || ro.state ? (ct = ro.state || (ro.state = new $I),
        qc = eo(ct.get),
        no = eo(ct.has),
        Fc = eo(ct.set),
        cn = function(e, t) {
    ...
    var jc = c((NU,Wc)=>{
        ...
        (Wc.exports = function(e, t, r, n) {
            ...
            (!ib(r, "name") || sb && r.name !== a) && Hc(r, "name", a),
            u = cb(r),
            u.source || (u.source = lb.join(typeof a == "string" ? a : ""))),
            e === nb) {
                o ? e[t] = r : ob(t, r);
                return
            } else
    ...
    var lo = c((DU,nl)=>{
        ...
        nl.exports = function(e, t) {
            var r = bb(e), n = 0, i = [], o;
            for (o in r)
                !co(Ab, o) && co(r, o) && rl(i, o);
            for (; t.length > n; )
                co(r, o = t[n++]) && (~Ob(i, o) || rl(i, o));
            return i
        }
    }
    );
    ...
    var vl = c((kU,hl)=>{
        ...
        hl.exports = function(e, t) {
            ...
            if (n ? s = fo : i ? s = fo[r] || Yb(r, {}) : s = (fo[r] || {}).prototype,
            s)
                for (a in t) {
                    if (f = t[a],
                    e.noTargetGet ? (p = jb(s, a),
                    u = p && p.value) : u = s[a],
                    o = Qb(n ? a : r + (i ? "." : "#") + a, e.forced),
                    !o && u !== void 0) {
                        if (typeof f == typeof u)
                            continue;
                        $b(f, u)
                    }
                    (e.sham || u && u.sham) && zb(f, "sham", !0),
                    Kb(s, a, f, e)
                }
        }
    }
    ...
    var _l = c((jU,ml)=>{
        ...
        ml.exports = e0 ? Object.defineProperties : function(t, r) {
            r0(t);
            for (var n = n0(r), i = i0(r), o = i.length, s = 0, a; o > s; )
                t0.f(t, a = i[s++], n[a]);
            return t
        }
    }
    ...
    var Rl = c((KU,Cl)=>{
        var a0 = pr(), s0 = _l(), bl = fn(), u0 = un(), c0 = Il(), l0 = Ki(), f0 = Ji(), Ol = ">", Al = "<", go = "prototype", ho = "script", xl = f0("IE_PROTO"), po = function() {}, wl = function(e) {
    ...
    var Ao = c(Er=>{
        ...
        function ff(e, t, r) {
            ...
            function d(E) {
                ...
                for (var b = s = a, v = 0; v < b.length; v++)
                    b[v]();
                return E
            }
            function m(E) {
        ...
        function _O() {
            ...
            return function(n) {
                return function(i, o, s) {
                    ...
                    u = EO.default.apply(void 0, f)(a.dispatch),
                    vO({}, a, {
                        dispatch: u
                    })
                }
    ...
    var DO, GO, VO, BO, UO, XO, HO, Mo, mf = ne(()=>{
        "use strict";
        hn();
        ({TRANSFORM_MOVE: DO, TRANSFORM_SCALE: GO, TRANSFORM_ROTATE: VO, TRANSFORM_SKEW: BO, STYLE_SIZE: UO, STYLE_FILTER: XO, STYLE_FONT_VARIATION: HO} = Oe),
        Mo = {
            [DO]: !0,
            [GO]: !0,
            [VO]: !0,
    ...
    var kO, WO, jO, zO, KO, YO, $O, QO, ZO, JO, eA, tA, rA, nA, iA, oA, aA, sA, uA, cA, _f = ne(()=>{
        ...
        WO = "IX2_SESSION_INITIALIZED",
        jO = "IX2_SESSION_STARTED",
        zO = "IX2_SESSION_STOPPED",
        KO = "IX2_PREVIEW_REQUESTED",
        YO = "IX2_PLAYBACK_REQUESTED",
        $O = "IX2_STOP_REQUESTED",
        QO = "IX2_CLEAR_REQUESTED",
        ZO = "IX2_EVENT_LISTENER_ADDED",
        JO = "IX2_EVENT_STATE_CHANGED",
        eA = "IX2_ANIMATION_FRAME_CHANGED",
        tA = "IX2_PARAMETER_CHANGED",
        rA = "IX2_INSTANCE_ADDED",
        nA = "IX2_INSTANCE_STARTED",
        iA = "IX2_INSTANCE_REMOVED",
        oA = "IX2_ELEMENT_STATE_CHANGED",
        aA = "IX2_ACTION_LIST_PLAYBACK_CHANGED",
        sA = "IX2_VIEWPORT_WIDTH_CHANGED",
        uA = "IX2_MEDIA_QUERIES_DEFINED",
        cA = "IX2_TEST_FRAME_RENDERED"
    }
    );
    var ge = {};
    be(ge, {
    ...
    var dS, bf, Of = ne(()=>{
        "use strict";
        Ae();
        ({IX2_RAW_DATA_IMPORTED: dS} = ce),
        bf = (e=Object.freeze({}),t)=>{
            switch (t.type) {
            case dS:
    ...
    var Ft = c(ae=>{
                ...
                if (f != null) {
                    ...
                    if (p.length)
                        for (var g = 0; g <= p.length; g++) {
                            ...
                            if (!(e && n[d] !== void 0)) {
                                var m = f[d];
                                t && vn(n[d]) && vn(m) && (m = Se(e, t, n[d], m)),
                                !(m === void 0 || m === n[d]) && (i || (i = !0,
                                n = yn(n)),
                                n[d] = m)
                            }
                        }
        ...
        function Vf(e, t, r, n, i, o, s) {
            ...
            for (var u = void 0, f = arguments.length, p = Array(f > 7 ? f - 7 : 0), g = 7; g < f; g++)
                p[g - 7] = arguments[g];
            return p.length ? u = Se.call.apply(Se, [null, !1, !1, a, r, n, i, o, s].concat(p)) : u = Se(!1, !1, a, r, n, i, o, s),
            _n(e, t, u)
        }
        function Bf(e, t) {
    ...
    var Hf, vS, yS, ES, mS, _S, Xf, kf, Wf = ne(()=>{
        ...
        Ae();
        Hf = Q(Ft()),
        {IX2_PREVIEW_REQUESTED: vS, IX2_PLAYBACK_REQUESTED: yS, IX2_STOP_REQUESTED: ES, IX2_CLEAR_REQUESTED: mS} = ce,
        _S = {
            preview: {},
            playback: {},
            stop: {},
    ...
    var Ee, TS, IS, bS, OS, AS, SS, xS, wS, CS, RS, jf, NS, zf, Kf = ne(()=>{
        ...
        Ae();
        Ee = Q(Ft()),
        {IX2_SESSION_INITIALIZED: TS, IX2_SESSION_STARTED: IS, IX2_TEST_FRAME_RENDERED: bS, IX2_SESSION_STOPPED: OS, IX2_EVENT_LISTENER_ADDED: AS, IX2_EVENT_STATE_CHANGED: SS, IX2_ANIMATION_FRAME_CHANGED: xS, IX2_ACTION_LIST_PLAYBACK_CHANGED: wS, IX2_VIEWPORT_WIDTH_CHANGED: CS, IX2_MEDIA_QUERIES_DEFINED: RS} = ce,
        jf = {
            active: !1,
            tick: 0,
            eventListeners: [],
        ...
        zf = (e=jf,t)=>{
            ...
            case bS:
                {
                    let {payload: {step: r=NS}} = t;
                    return (0,
                    Ee.set)(e, "tick", e.tick + r)
                }
            case OS:
                return jf;
            case xS:
            ...
            case AS:
                {
                    let r = (0,
                    Ee.addLast)(e.eventListeners, t.payload);
                    return (0,
                    Ee.set)(e, "eventListeners", r)
                }
            case SS:
                {
                    let {stateKey: r, newState: n} = t.payload;
                    return (0,
                    Ee.setIn)(e, ["eventState", r], n)
                }
            case wS:
                {
                    let {actionListId: r, isPlaying: n} = t.payload;
                    return (0,
                    Ee.setIn)(e, ["playbackState", r], n)
                }
            case CS:
                {
            ...
            case RS:
                return (0,
                Ee.set)(e, "hasDefinedMediaQueries", !0);
            default:
                return e
            }
        }
    ...
    var ed = c((kX,Jf)=>{
        ...
        function VS(e) {
            ...
            if (r < 0)
                return !1;
            var n = t.length - 1;
            return r == n ? t.pop() : GS.call(t, r, 1),
            --this.size,
            !0
        }
        Jf.exports = VS
        ...
        function Ww(e, t, r, n, i, o) {
            ...
            o.set(t, e); ++g < a; ) {
                var O = e[g]
                  , E = t[g];
                if (n)
                    var b = s ? n(E, O, g, t, e, o) : n(O, E, g, e, t, o);
                if (b !== void 0) {
                    if (b)
                        continue;
                    d = !1;
    ...
    var Ko = c(($H,sg)=>{
        ...
        function FR(e, t) {
            var r = CR(e)
              ...
              , u = a.length;
            for (var f in e)
                (t || qR.call(e, f)) && !(s && (f == "length" || i && (f == "offset" || f == "parent") || o && (f == "buffer" || f == "byteLength" || f == "byteOffset") || NR(f, u))) && a.push(f);
            return a
        }
        sg.exports = FR
    }
        ...
        function oN(e, t, r, n, i, o) {
            ...
            for (var b = s; ++g < u; ) {
                ...
                var v = e[d]
                  , S = t[d];
                if (n)
                    var I = s ? n(S, v, d, t, e, o) : n(v, S, d, e, t, o);
    ...
    var Bg = c((ck,Vg)=>{
        ...
        function RN(e, t, r, n, i, o) {
            ...
            if (d && !p)
                return o || (o = new ta),
                s || xN(e) ? ON(e, t, r, n, i, o) : AN(e, t, u, r, n, i, o);
            if (!(r & wN)) {
        ...
        function MN(e, t, r, n) {
            ...
            for (; ++i < o; ) {
                ...
                if (s && a[2]) {
                    ...
                    if (n)
                        var d = n(f, p, u, e, t, g);
                    if (!(d === void 0 ? PN(p, f, qN | FN, n, g) : d))
                        return !1
                }
            }
            return !0
    ...
    var rh = c((Ek,th)=>{
        ...
        function oa(e, t) {
            ...
            return r.cache = new (oa.Cache || eh),
            r
        }
        oa.Cache = eh;
        th.exports = oa
    ...
    var Zh, Ve, Vn, XP, da, pt, Qh, Bn, Un = ne(()=>{
        ...
        Vn = (e,t)=>Ve ? e() : t,
        XP = Vn(()=>(0,
        Zh.default)(["matches", "matchesSelector", "mozMatchesSelector", "msMatchesSelector", "oMatchesSelector", "webkitMatchesSelector"], e=>e in Element.prototype)),
        da = Vn(()=>{
        ...
        , "transform"),
        Qh = pt.split("transform")[0],
        Bn = Qh ? Qh + "TransformStyle" : "transformStyle"
    }
    );
    var pa = c((jk,iv)=>{
        var HP = 4
        ...
        iv.exports = function(t, r, n, i) {
            ...
            if (t !== r || n !== i)
                for (var s = 0; s < Rr; ++s)
                    o[s] = Hn(s * Xn, t, n);
            function a(u) {
                for (var f = 0, p = 1, g = Rr - 1; p !== g && o[p] <= u; ++p)
                    f += Xn;
                --p;
    ...
    var Nr, et, $P, QP, ZP, JP, ga = ne(()=>{
        ...
        et = 1.70158,
        $P = (0,
        Nr.default)(.25, .1, .25, 1),
        QP = (0,
        Nr.default)(.42, 0, 1, 1),
        ZP = (0,
        Nr.default)(0, 0, .58, 1),
        JP = (0,
        Nr.default)(.42, 0, .58, 1)
    }
    );
    var av = {};
    be(av, {
    ...
    var kt, Kk, Fq, Yk, Mq, Dq, Gq, Vq, Bq, Uq, Xq, Hq, kq, Wq, jq, sv, zq, Kq, Yq, lv = ne(()=>{
        ...
        kt = Q(Ft());
        Ae();
        ({HTML_ELEMENT: Kk, PLAIN_OBJECT: Fq, ABSTRACT_NODE: Yk, CONFIG_X_VALUE: Mq, CONFIG_Y_VALUE: Dq, CONFIG_Z_VALUE: Gq, CONFIG_VALUE: Vq, CONFIG_X_UNIT: Bq, CONFIG_Y_UNIT: Uq, CONFIG_Z_UNIT: Xq, CONFIG_UNIT: Hq} = ge),
        {IX2_SESSION_STOPPED: kq, IX2_INSTANCE_ADDED: Wq, IX2_ELEMENT_STATE_CHANGED: jq} = ce,
        sv = {},
        zq = "refState",
        Kq = (e=sv,t={})=>{
            switch (t.type) {
            ...
            case Wq:
                {
                    let {elementId: r, element: n, origin: i, actionItem: o, refType: s} = t.payload
                      ...
                      , u = e;
                    return (0,
                    kt.getIn)(u, [r, n]) !== n && (u = uv(u, n, s, r, o)),
                    va(u, r, a, i, o)
                }
            case jq:
                {
        ...
        var dv = Object.freeze({
          ...
          , cF = (e,t)=>{
            ...
            if (e) {
                let o = Object.keys(e)
                  , s = aF(n, o);
                return s.length ? s.reduce((u,f)=>(u[f] = dv[f],
                u), e) : e
            }
            return n.reduce((o,s)=>(o[s] = dv[s],
            o), {})
        }
        ;
    ...
    var Ea = c(ya=>{
        ...
        function gF(e) {
            let t, r, n, i = 1, o = e.replace(/\s/g, "").toLowerCase(), a = (typeof gv[o] == "string" ? gv[o].toLowerCase() : null) || o;
            if (a.startsWith("#")) {
                let u = a.substring(1);
                ...
                i = parseFloat(u[3]);
                let d = (1 - Math.abs(2 * g - 1)) * p, m = d * (1 - Math.abs(f / 60 % 2 - 1)), O = g - d / 2, E, b, v;
                f >= 0 && f < 60 ? (E = d,
                b = m,
                v = 0) : f >= 60 && f < 120 ? (E = m,
                b = d,
                ...
                b = 0,
                v = m),
                t = Math.round((E + O) * 255),
                r = Math.round((b + O) * 255),
                n = Math.round((v + O) * 255)
            } else if (a.startsWith("hsl")) {
                let u = a.match(/hsl\(([^)]+)\)/)[1].split(","), f = parseFloat(u[0]), p = parseFloat(u[1].replace("%", "")) / 100, g = parseFloat(u[2].replace("%", "")) / 100, d = (1 - Math.abs(2 * g - 1)) * p, m = d * (1 - Math.abs(f / 60 % 2 - 1)), O = g - d / 2, E, b, v;
                f >= 0 && f < 60 ? (E = d,
                b = m,
                v = 0) : f >= 60 && f < 120 ? (E = m,
                b = d,
    ...
    var vv = c(kn=>{
        ...
        Xe(If))
          ...
          , OF = _a(pv())
          , AF = _a(hv())
          , eW = kn.pluginMethodMap = new Map([[ma.ActionTypeConsts.PLUGIN_LOTTIE, {
            ...bF
    ...
    var Ta, It, Ia, ba, SF, Oa, xF, Aa, Sa, xa = ne(()=>{
        ...
        ,
        Ia = It("getPluginConfig"),
        ba = It("getPluginOrigin"),
        SF = It("getPluginDuration"),
        Oa = It("getPluginDestination"),
        xF = It("createPluginInstance"),
        Aa = It("renderPlugin"),
        Sa = It("clearPlugin")
    }
    );
    ...
    var Fv = c((dW,qv)=>{
        ...
        function JF(e, t, r) {
            ...
            if (!n)
                return -1;
            var i = n - 1;
            return r !== void 0 && (i = $F(r),
            i = r < 0 ? QF(n + i, 0) : ZF(i, n - 1)),
            KF(e, YF(t, 3), i, !0)
        }
        qv.exports = JF
    }
    ...
    function nM(e, t) {
        ...
        for (let i = 0; i < r.length; i++)
            if (!Object.hasOwn(t, r[i]) || !Gv(e[r[i]], t[r[i]]))
                return !1;
        return !0
    }
    var Ra, Vv = ne(()=>{
    ...
    function xM({store: e, select: t, onChange: r, comparator: n=SM}) {
    ...
    function Fa({config: e, event: t, eventTarget: r, elementRoot: n, elementApi: i}) {
        if (!i)
            throw new Error("IX2 missing elementApi");
        let {targets: o} = e;
        if (Array.isArray(o) && o.length > 0)
            return o.reduce((L,_)=>L.concat(Fa({
                config: {
                    target: _
                },
                event: t,
        ...
        let {getValidDocument: s, getQuerySelector: a, queryDocument: u, getChildElements: f, getSiblingElements: p, matchSelector: g, elementContains: d, isSiblingNode: m} = i
          , {target: O} = e;
        if (!O)
            return [];
        let {id: E, objectId: b, selector: v, selectorGuids: S, appliesTo: I, useEventTarget: w} = Xv(O);
        if (b)
            return [Wn.has(b) ? Wn.get(b) : Wn.set(b, {}).get(b)];
        if (I === qo.PAGE) {
            let L = s(E);
            return L ? [L] : []
        }
        let x = (t?.action?.config?.affectedElements ?? {})[E || v] || {}, F = !!(x.id || x.selector), M, G, U, k = t && a(Xv(t.target));
        if (F ? (M = x.limitAffectedElements,
        G = k,
        U = a(x)) : G = U = a({
            id: E,
            selector: v,
        ...
        t && w) {
            ...
            if (U) {
                if (w === yM)
                    return u(U).filter(_=>L.some(N=>d(_, N)));
                if (w === Bv)
                    return u(U).filter(_=>L.some(N=>d(N, _)));
                if (w === Uv)
                    return u(U).filter(_=>L.some(N=>m(N, _)))
            }
            return L
        }
    ...
    function NM(e, t={}, r={}, n, i) {
        ...
        case $v:
            return {
                value: (0,
                tt.default)(parseFloat(o(e, zn)), 1)
            };
        case Yt:
            {
                let a = o(e, Ke), u = o(e, Ye), f, p;
                return n.config.widthUnit === gt ? f = Hv.test(a) ? parseFloat(a) : parseFloat(r.width) : f = (0,
                tt.default)(parseFloat(a), parseFloat(r.width)),
                n.config.heightUnit === gt ? p = Hv.test(u) ? parseFloat(u) : parseFloat(r.height) : p = (0,
                tt.default)(parseFloat(u), parseFloat(r.height)),
                {
                    widthValue: f,
                    heightValue: p
                }
    ...
    function XM(e, t, r, n, i) {
        let o = UM.map(a=>{
            let u = Ma[a]
              , {xValue: f=u.xValue, yValue: p=u.yValue, zValue: g=u.zValue, xUnit: d="", yUnit: m="", zUnit: O=""} = t[a] || {};
            switch (a) {
            case jt:
    ...
    function HM(e, t, r, n) {
        let i = (0,
        Yn.default)(t, (s,a,u)=>`${s} ${u}(${a}${BM(u, r)})`, "")
          , {setStyle: o} = n;
        bt(e, qr, n),
        o(e, qr, i)
    }
    ...
    function $M({element: e, actionTypeId: t, computedStyle: r, getStyle: n}) {
        let i = qa[t]
          , o = n(e, i)
          , s = zM.test(o) ? o : r[i]
          , a = YM(KM, s).split(Mr);
        return {
            rValue: (0,
            tt.default)(parseInt(a[0], 10), 255),
            gValue: (0,
            tt.default)(parseInt(a[1], 10), 255),
            bValue: (0,
            tt.default)(parseInt(a[2], 10), 255),
            aValue: (0,
            tt.default)(parseFloat(a[3]), 1)
        }
    }
    ...
    function e1(e, t, r) {
        ...
        if (o === Yt) {
            let {config: s} = t;
            s.widthUnit === gt && n(e, Ke, ""),
            s.heightUnit === gt && n(e, Ye, "")
        }
        i(e, Wt) && ty({
            effect: ey,
            actionTypeId: o,
    ...
    var tt, Yn, jn, $n, jv, iM, oM, aM, sM, uM, cM, lM, fM, dM, pM, zn, qr, Fr, Ke, Ye, zv, gM, hM, Bv, vM, Uv, yM, Kn, Wt, gt, Mr, EM, Na, Kv, La, Pa, Yv, jt, zt, Kt, Dr, $v, Gr, Vr, Yt, $t, Qt, Zt, Qn, mM, Qv, qa, Zv, Wn, TM, bM, SM, Hv, CM, RM, LM, PM, qM, Ma, GM, VM, BM, UM, jM, zM, KM, ty, iy = ne(()=>{
        ...
        xa();
        Un();
        ({BACKGROUND: iM, TRANSFORM: oM, TRANSLATE_3D: aM, SCALE_3D: sM, ROTATE_X: uM, ROTATE_Y: cM, ROTATE_Z: lM, SKEW: fM, PRESERVE_3D: dM, FLEX: pM, OPACITY: zn, FILTER: qr, FONT_VARIATION_SETTINGS: Fr, WIDTH: Ke, HEIGHT: Ye, BACKGROUND_COLOR: zv, BORDER_COLOR: gM, COLOR: hM, CHILDREN: Bv, IMMEDIATE_CHILDREN: vM, SIBLINGS: Uv, PARENT: yM, DISPLAY: Kn, WILL_CHANGE: Wt, AUTO: gt, COMMA_DELIMITER: Mr, COLON_DELIMITER: EM, BAR_DELIMITER: Na, RENDER_TRANSFORM: Kv, RENDER_GENERAL: La, RENDER_STYLE: Pa, RENDER_PLUGIN: Yv} = ge),
        {TRANSFORM_MOVE: jt, TRANSFORM_SCALE: zt, TRANSFORM_ROTATE: Kt, TRANSFORM_SKEW: Dr, STYLE_OPACITY: $v, STYLE_FILTER: Gr, STYLE_FONT_VARIATION: Vr, STYLE_SIZE: Yt, STYLE_BACKGROUND_COLOR: $t, STYLE_BORDER: Qt, STYLE_TEXT_COLOR: Zt, GENERAL_DISPLAY: Qn, OBJECT_VALUE: mM} = Oe,
        Qv = e=>e.trim(),
        qa = Object.freeze({
            [$t]: zv,
            [Qt]: gM,
        ...
        SM = (e,t)=>e === t;
        Hv = /px/,
        CM = (e,t)=>t.reduce((r,n)=>(r[n.type] == null && (r[n.type] = GM[n.type]),
        r), e || {}),
        RM = (e,t)=>t.reduce((r,n)=>(r[n.type] == null && (r[n.type] = VM[n.type] || n.defaultValue || 0),
        r), e || {});
        LM = (e,t)=>(t && (e[t.type] = t.value || 0),
        e),
        PM = (e,t)=>(t && (e[t.type] = t.value || 0),
        e),
        qM = (e,t,r)=>{
            if (Tt(e))
                return Ia(e)(r, t);
        ...
        zM = /^rgb/,
        KM = RegExp(`rgba?${jM}`);
        ty = ({effect: e, actionTypeId: t, elementApi: r})=>n=>{
            switch (t) {
            case jt:
            case zt:
            case Kt:
    ...
    var Jn, rt, h1, v1, y1, E1, m1, _1, Zn, oy, T1, I1, Da, b1, O1, A1, S1, ay, sy = ne(()=>{
        ...
        Jn = Q(Ot()),
        rt = Q(Ft()),
        {IX2_RAW_DATA_IMPORTED: h1, IX2_SESSION_STOPPED: v1, IX2_INSTANCE_ADDED: y1, IX2_INSTANCE_STARTED: E1, IX2_INSTANCE_REMOVED: m1, IX2_ANIMATION_FRAME_CHANGED: _1} = ce,
        {optimizeFloat: Zn, applyEasing: oy, createBezierEasing: T1} = Jn.IX2EasingUtils,
        {RENDER_GENERAL: I1} = ge,
        {getItemConfigByKey: Da, getRenderType: b1, getStyleProp: O1} = Jn.IX2VanillaUtils,
        A1 = (e,t)=>{
        ...
        ,
        S1 = (e,t)=>{
            let {active: r, origin: n, start: i, immediate: o, renderType: s, verbose: a, actionItem: u, destination: f, destinationKeys: p, pluginDuration: g, instanceDelay: d, customEasingFn: m, skipMotion: O} = e
              , E = u.config.easing
            ...
            if (r && n) {
                ...
                if (a) {
                    ...
                    e = (0,
                    rt.set)(e, "verboseTimeElapsed", G * U)
                }
                if (I < 0)
                    return e;
        ...
        ay = (e=Object.freeze({}),t)=>{
            ...
            case y1:
                {
                    let {instanceId: r, elementId: n, actionItem: i, eventId: o, eventTarget: s, eventStateKey: a, actionListId: u, groupIndex: f, isCarrier: p, origin: g, destination: d, immediate: m, verbose: O, continuous: E, parameterId: b, actionGroups: v, smoothing: S, restingValue: I, pluginInstance: w, pluginDuration: R, instanceDelay: x, skipMotion: F, skipToValue: M} = t.payload
                      , {actionTypeId: G} = i
                      , U = b1(G)
                      , k = O1(U, G)
    ...
    var x1, w1, C1, uy, cy = ne(()=>{
        "use strict";
        Ae();
        ({IX2_RAW_DATA_IMPORTED: x1, IX2_SESSION_STOPPED: w1, IX2_PARAMETER_CHANGED: C1} = ce),
        uy = (e={},t)=>{
            switch (t.type) {
            case x1:
    ...
    var ly, fy, R1, N1, py = ne(()=>{
        ...
        sy();
        cy();
        ({ixElements: R1} = fy.IX2ElementsReducer),
        N1 = (0,
        ly.combineReducers)({
            ixData: bf,
            ixRequest: kf,
    ...
    var wy = c((PW,xy)=>{
        ...
        function oD(e) {
            for (var t = _y.lastIndex = 0; _y.test(e); )
                ++t;
            return t
        }
        xy.exports = oD
    ...
    var aE = c((YW,oE)=>{
        ...
        function A2(e) {
            if (e == null)
                return !0;
            if (y2(e) && (v2(e) || typeof e == "string" || typeof e.splice == "function" || E2(e) || _2(e) || h2(e)))
                return !e.length;
            var t = g2(e);
            if (t == T2 || t == I2)
                return !e.size;
    ...
    var IE, Y2, $2, Q2, Z2, J2, eG, tG, rG, nG, iG, oG, aG, sG, uG, cG, lG, fG, dG, pG, gG, hG, Ha, ka, Wa, ja, vG, yG, EG, mG, ei, _G, za, ti, er, Ka, ri, Ya, $a, tr, Qa, Za, ni = ne(()=>{
        ...
        Ae();
        IE = Q(Ot()),
        {IX2_RAW_DATA_IMPORTED: Y2, IX2_SESSION_INITIALIZED: $2, IX2_SESSION_STARTED: Q2, IX2_SESSION_STOPPED: Z2, IX2_PREVIEW_REQUESTED: J2, IX2_PLAYBACK_REQUESTED: eG, IX2_STOP_REQUESTED: tG, IX2_CLEAR_REQUESTED: rG, IX2_EVENT_LISTENER_ADDED: nG, IX2_TEST_FRAME_RENDERED: iG, IX2_EVENT_STATE_CHANGED: oG, IX2_ANIMATION_FRAME_CHANGED: aG, IX2_PARAMETER_CHANGED: sG, IX2_INSTANCE_ADDED: uG, IX2_INSTANCE_STARTED: cG, IX2_INSTANCE_REMOVED: lG, IX2_ELEMENT_STATE_CHANGED: fG, IX2_ACTION_LIST_PLAYBACK_CHANGED: dG, IX2_VIEWPORT_WIDTH_CHANGED: pG, IX2_MEDIA_QUERIES_DEFINED: gG} = ce,
        {reifyState: hG} = IE.IX2VanillaUtils,
        Ha = e=>({
            type: Y2,
            payload: {
                ...hG(e)
        ...
        yG = ({actionTypeId: e=Oe.GENERAL_START_ACTION, actionListId: t, actionItemId: r, eventId: n, allowEvents: i, immediate: o, testManual: s, verbose: a, rawData: u})=>({
            type: eG,
            payload: {
                actionTypeId: e,
                actionListId: t,
    ...
    var AE, Ja, OE, TG, IG, SE, Br, xE = ne(()=>{
        ...
        AE = Q(Ot());
        Ae();
        ({ELEMENT_MATCHES: Ja} = AE.IX2BrowserSupport),
        {IX2_ID_DELIMITER: OE, HTML_ELEMENT: TG, PLAIN_OBJECT: IG, WF_PAGE: SE} = ge;
    ...
    var Em = c((Aj,ym)=>{
        ...
        function bV(e) {
            ...
            return t.__actions__ = IV(e.__actions__),
    ...
    var bm = c((xj,Im)=>{
        ...
        function FV(e) {
            var t = PV(e)
              , r = qV[t];
            if (typeof r != "function" || !(t in NV.prototype))
                return !1;
            if (e === r)
                return !0;
            var n = LV(r);
    ...
    var Xm, Hm, km, Wm, $V, QV, ZV, JV, eB, tB, rB, nB, iB, oB, aB, sB, uB, cB, lB, jm, zm, fB, dB, pB, Km, gB, hB, Ym, vB, us, $m, qm, Fm, Qm, Xr, yB, $e, Zm, EB, xe, Be, Hr, Jm, cs, Mm, ls, mB, Ur, _B, TB, IB, e_, Dm, bB, Gm, OB, AB, SB, Vm, li, fi, Bm, Um, t_, r_ = ne(()=>{
        ...
        ni();
        Wm = Q(Ot()),
        {MOUSE_CLICK: $V, MOUSE_SECOND_CLICK: QV, MOUSE_DOWN: ZV, MOUSE_UP: JV, MOUSE_OVER: eB, MOUSE_OUT: tB, DROPDOWN_CLOSE: rB, DROPDOWN_OPEN: nB, SLIDER_ACTIVE: iB, SLIDER_INACTIVE: oB, TAB_ACTIVE: aB, TAB_INACTIVE: sB, NAVBAR_CLOSE: uB, NAVBAR_OPEN: cB, MOUSE_MOVE: lB, PAGE_SCROLL_DOWN: jm, SCROLL_INTO_VIEW: zm, SCROLL_OUT_OF_VIEW: fB, PAGE_SCROLL_UP: dB, SCROLLING_IN_VIEW: pB, PAGE_FINISH: Km, ECOMMERCE_CART_CLOSE: gB, ECOMMERCE_CART_OPEN: hB, PAGE_START: Ym, PAGE_SCROLL: vB} = Ge,
        us = "COMPONENT_ACTIVE",
        $m = "COMPONENT_INACTIVE",
        {COLON_DELIMITER: qm} = ge,
        {getNamespacedParameterId: Fm} = Wm.IX2VanillaUtils,
        Qm = e=>t=>typeof t == "object" && e(t) ? !0 : t,
        Xr = Qm(({element: e, nativeEvent: t})=>e === t.target),
        ...
        xe = ({store: e, event: t, element: r, eventStateKey: n},i)=>{
            ...
            return f && rr({
                ...
                actionListId: (0,
                Hm.default)(f, "action.config.actionListId")
            }),
            rr({
                store: e,
                eventId: s,
        ...
        Ur = (()=>{
            ...
            return ()=>({
                ...
                stiffScrollTop: (0,
                km.default)(e ? window.pageYOffset : r.scrollTop, 0, r.scrollHeight - window.innerHeight),
        ...
        _B = (e,t)=>!(e.left > t.right || e.right < t.left || e.top > t.bottom || e.bottom < t.top),
        TB = ({element: e, nativeEvent: t})=>{
        ...
        e_ = e=>(t,r)=>{
            let {type: n} = t.nativeEvent
              , i = [us, $m].indexOf(n) !== -1 ? n === us : r.isActive
              , o = {
                ...r,
                isActive: i
            };
        ...
        ,
        OB = (e,t)=>e.left > t.left && e.left < t.right && e.top > t.top && e.top < t.bottom,
        AB = e=>(t,r)=>{
            let n = {
        ...
        Bm = {
            ...
            handler: bB((e,t)=>{
                let {elementVisible: r} = t
                  ...
                  , {ixData: o} = i.getState()
                  , {events: s} = o;
                return !s[n.action.config.autoStopEventId] && t.triggered ? t : n.eventTypeId === zm === r ? (xe(e),
                {
                    ...t,
                    triggered: !0
                }) : t
        ...
        t_ = {
            ...
            [$V]: {
                types: "click",
                handler: Be($e, Vm((e,{clickCount: t})=>{
                    EB(e) ? t === 1 && xe(e) : xe(e)
                }
                ))
            },
            ...
            [lB]: {
                ...
                handler: ({store: e, element: t, eventConfig: r, nativeEvent: n, eventStateKey: i},o={
                    ...
                    let {basedOn: s, selectedAxis: a, continuousParameterGroupId: u, reverse: f, restingState: p=0} = r
                      , {clientX: g=o.clientX, clientY: d=o.clientY, pageX: m=o.pageX, pageY: O=o.pageY} = n
                      , E = a === "X_AXIS"
                      , b = n.type === "mouseout"
                      , v = p / 100
                      , S = u
                    ...
                    case je.PAGE:
                        {
                            let {scrollLeft: w, scrollTop: R, scrollWidth: x, scrollHeight: F} = Ur();
                            v = E ? Math.min(w + m, x) / x : Math.min(R + O, F) / F;
                            break
                        }
                    case je.ELEMENT:
                    default:
                    ...
                    return b && (v > 1 - Um || v < Um) && (v = Math.round(v)),
                    (s !== je.ELEMENT || I || I !== o.elementHovered) && (v = f ? 1 - v : v,
                    e.dispatch(er(S, v))),
                    {
                        elementHovered: I,
                        clientX: g,
            ...
            [vB]: {
                ...
                handler: ({store: e, eventConfig: t})=>{
                    let {continuousParameterGroupId: r, reverse: n} = t
                      , {scrollTop: i, scrollHeight: o, clientHeight: s} = Ur()
                      , a = i / (o - s);
                    a = n ? 1 - a : a,
                    e.dispatch(er(r, a))
                }
            ...
            [pB]: {
                ...
                handler: ({element: e, store: t, eventConfig: r, eventStateKey: n},i={
                    ...
                    let {scrollLeft: o, scrollTop: s, scrollWidth: a, scrollHeight: u, clientHeight: f} = Ur()
                      , {basedOn: p, selectedAxis: g, continuousParameterGroupId: d, startsEntering: m, startsExiting: O, addEndOffset: E, addStartOffset: b, addOffsetValue: v=0, endOffsetValue: S=0} = r
                      , I = g === "X_AXIS";
                    if (p === je.VIEWPORT) {
                        let w = I ? o / a : s / u;
    ...
    function YB({rawData: e, defer: t}, r) {
        let n = ()=>{
            yi({
                store: r,
                rawData: e,
    ...
    function yi({store: e, rawData: t, allowEvents: r, testManual: n}) {
        ...
        t && e.dispatch(Ha(t)),
        i.active || (e.dispatch(ka({
            hasBoundaryNodes: !!document.querySelector(pi),
            reducedMotion: document.body.hasAttribute("data-wf-ix-vacation") && window.matchMedia("(prefers-reduced-motion)").matches
        })),
        r && (i5(e),
        JB(),
        e.getState().ixSession.hasDefinedMediaQueries && zB(e)),
        e.dispatch(Wa()),
        e5(e, n))
    }
    function JB() {
    ...
    function e5(e, t) {
        let r = n=>{
            ...
            i.active && (e.dispatch(ti(n, o)),
            t ? KB(e, r) : requestAnimationFrame(r))
        }
        ;
    ...
    function t5({target: e, listenerParams: t}) {
        e.removeEventListener.apply(e, t)
    }
    function r5({store: e, eventStateKey: t, eventTarget: r, eventId: n, eventConfig: i, actionListId: o, parameterGroup: s, smoothing: a, restingValue: u}) {
    ...
    function l5({logic: e, store: t, events: r}) {
        f5(r);
        ...
        nr.default)(a, (g,d)=>{
            let m = r[d]
              , {action: O, id: E, mediaQueries: b=o.mediaQueryKeys} = m
              , {actionListId: v} = O.config;
            UB(b, o.mediaQueryKeys) || t.dispatch(Za()),
            O.actionTypeId === Oe.GENERAL_CONTINUOUS_ACTION && (Array.isArray(m.config) ? m.config : [m.config]).forEach(I=>{
                let {continuousParameterGroupId: w} = I
                  , R = (0,
                nt.default)(s, `${v}.continuousParameterGroups`, [])
                  , x = (0,
                o_.default)(R, ({id: G})=>G === w)
                  , F = (I.smoothing || 0) / 100
        ...
        let u = g=>{
          ...
          , f = (0,
        l_.default)(u, WB)
          , p = ({target: g=document, types: d, throttle: m})=>{
            d.split(" ").filter(Boolean).forEach(O=>{
                let E = m ? f : u;
                g.addEventListener(O, E),
                t.dispatch(ei(g, [O, E]))
            }
            )
        }
    ...
    function f5(e) {
        ...
        for (let n in e) {
            let {eventTypeId: i, target: o} = e[n]
              , s = es(o);
            t[s] || (i === Ge.MOUSE_CLICK || i === Ge.MOUSE_SECOND_CLICK) && (t[s] = !0,
    ...
    function h_({store: e, actionListId: t, eventId: r}) {
        ...
        if (u && u.useFirstGroupAsInitialState) {
            ...
            nt.default)(u, "actionItemGroups[0].actionItems", [])
              , p = (0,
            nt.default)(a, "mediaQueries", n.mediaQueryKeys);
            if (!hi(p, i.mediaQueryKey))
                return;
            f.forEach(g=>{
                let {config: d, actionTypeId: m} = g
                  , O = d?.target?.useEventTarget === !0 && d?.target?.objectId == null ? {
                    target: a.target,
                    targets: a.targets
                } : d
                  , E = gi({
    ...
    function rr({store: e, eventId: t, eventTarget: r, eventStateKey: n, actionListId: i}) {
        let {ixInstances: o, ixSession: s} = e.getState()
          , a = s.hasBoundaryNodes && r ? Br(r, pi) : null;
        (0,
        nr.default)(o, u=>{
            let f = (0,
            ...
            if (u.actionListId === i && u.eventId === t && p) {
                if (a && f && !ts(a, u.element))
                    return;
                ys(u, e),
                u.verbose && e.dispatch(tr({
                    actionListId: i,
                    isPlaying: !1
                }))
            }
    ...
    function kr({store: e, eventId: t, eventTarget: r, eventStateKey: n, actionListId: i, groupIndex: o=0, immediate: s, verbose: a}) {
        let {ixData: u, ixSession: f} = e.getState()
          , {events: p} = u
          , g = p[t] || {}
          , {mediaQueries: d=u.mediaQueryKeys} = g
          , m = (0,
        nt.default)(u, `actionLists.${i}`, {})
          , {actionItemGroups: O, useFirstGroupAsInitialState: E} = m;
        if (!O || !O.length)
            return !1;
        o >= O.length && (0,
        nt.default)(g, "config.loop") && (o = 0),
        o === 0 && E && o++;
        let v = (o === 0 || o === 1 && E) && ds(g.action?.actionTypeId) ? g.config.delay : void 0
          , S = (0,
        nt.default)(O, [o, "actionItems"], []);
        if (!S.length || !hi(d, f.mediaQueryKey))
            return !1;
    ...
    function vs(e) {
        let {store: t, computedStyle: r, ...n} = e, {element: i, actionItem: o, immediate: s, pluginInstance: a, continuous: u, restingValue: f, eventId: p} = n, g = !u, d = RB(), {ixElements: m, ixSession: O, ixData: E} = t.getState(), b = CB(m, i), {refState: v} = m[b] || {}, S = rs(i), I = O.reducedMotion && Mo[o.actionTypeId], w;
        if (I && u)
        ...
        y_(document.body, "ix2-animation-started", d),
        s) {
            d5(t, d);
            return
        }
    ...
    function d5(e, t) {
        ...
        e.dispatch(ri(t, 0)),
        e.dispatch(ti(performance.now(), r));
        let {ixInstances: n} = e.getState();
        E_(n[t], e)
    }
    function E_(e, t) {
        let {active: r, continuous: n, complete: i, elementId: o, actionItem: s, actionTypeId: a, renderType: u, current: f, groupIndex: p, eventId: g, eventTarget: d, eventStateKey: m, actionListId: O, isCarrier: E, styleProp: b, verbose: v, pluginInstance: S} = e
    ...
    var o_, nt, a_, s_, u_, c_, nr, l_, di, xB, ds, ps, pi, f_, wB, n_, gi, CB, gs, At, RB, NB, d_, LB, PB, qB, FB, MB, DB, hi, GB, VB, BB, UB, XB, vi, hs, HB, i_, kB, WB, o5, s5, u5, c5, fs = ne(()=>{
        ...
        xB = Object.keys(gn),
        ds = e=>xB.includes(e),
        {COLON_DELIMITER: ps, BOUNDARY_SELECTOR: pi, HTML_ELEMENT: f_, RENDER_GENERAL: wB, W_MOD_IX: n_} = ge,
        {getAffectedElements: gi, getElementId: CB, getDestinationValues: gs, observeStore: At, getInstanceId: RB, renderHTMLElement: NB, clearAllStyles: d_, getMaxDurationItemIndex: LB, getComputedStyle: PB, getInstanceOrigin: qB, reduceListToGroup: FB, shouldNamespaceEventParameter: MB, getNamespacedParameterId: DB, shouldAllowMediaQuery: hi, cleanupHTMLElement: GB, clearObjectCache: VB, stringifyTarget: BB, mediaQueriesEqual: UB, shallowEqual: XB} = di.IX2VanillaUtils,
        {isPluginType: vi, createPluginInstance: hs, getPluginDuration: HB} = di.IX2VanillaPlugins,
        i_ = navigator.userAgent,
        kB = i_.match(/iPad/i) || i_.match(/iPhone/),
        WB = 12;
        o5 = ["resize", "orientationchange"];
        s5 = (e,t)=>(0,
        s_.default)((0,
        c_.default)(e, t), u_.default),
        u5 = (e,t)=>{
            (0,
            nr.default)(e, (r,n)=>{
                r.forEach((i,o)=>{
    ...
    var T_ = c(it=>{
        ...
        it.actions = y5;
        var ms = it.store = (0,
        h5.createStore)(v5.default);
        function E5(e) {
            e() && (0,
            Es.observeRequests)(ms)
        }
        function m5(e) {
            __(),
            (0,
    ...
    var x_ = c((Uj,S_)=>{
        ...
        ir.define("links", S_.exports = function(e, t) {
            var r = {}, n = e(window), i, o = ir.env(), s = window.location, a = document.createElement("a"), u = "w--current", f = /index\.(html|php)$/, p = /\/$/, g, d;
            r.ready = r.design = r.preview = m;
            function m() {
                i = o && ir.env("design"),
                d = ir.env("slug") || s.pathname || "",
                ir.scroll.off(E),
                g = [];
                for (var v = document.links, S = 0; S < v.length; ++S)
                    O(v[S]);
                g.length && (ir.scroll.on(E),
                E())
            }
            function O(v) {
    ...
    var C_ = c((Xj,w_)=>{
        ...
        mi.define("scroll", w_.exports = function(e) {
            ...
            function I(L, _) {
                ...
                case "add":
                    N = L.attr("tabindex"),
                    N ? L.attr("data-wf-tabindex-swap", N) : L.attr("tabindex", "-1");
                    break;
                case "remove":
            ...
            function x(L, _) {
                ...
                if (N !== D) {
                    var q = M(L, N, D)
                      ...
                      , H = function() {
                        var ee = Date.now() - W;
                        window.scroll(0, G(N, D, ee, q)),
                        ee <= q ? a(H) : typeof _ == "function" && _()
                    };
                    a(H)
                }
            }
                ...
                function d(b) {
                    if (s) {
                        ...
                        var v = b.touches
                          ...
                          , I = S - p;
                        p = S,
                        Math.abs(I) > u && r && String(r()) === "" && (i("swipe", b, {
...
Webflow.require('ix2').init({
    "events": {
        "e-3": {
            ...
            "target": {
                "id": "62b93934fb5c4c15be45bff3|566b753a-e2c1-97e4-40b5-228f15ad97cd",
                "appliesTo": "ELEMENT",
                "styleBlockIds": []
            },
            "targets": [{
        ...
        "e-14": {
            ...
            "mediaQueries": ["main", "medium", "small", "tiny"],
            "target": {
                "id": "62b93934fb5c4c15be45bff3|e048c722-9bf2-9753-374e-e8f24afcb629",
                "appliesTo": "ELEMENT",
                "styleBlockIds": []
            },
            "targets": [{
        ...
        "e-27": {
            ...
            "mediaQueries": ["main", "medium", "small", "tiny"],
            "target": {
                "id": "64c3a23e8e3559214f1aeb4d|f82e77f0-6fad-23e6-a82c-1e5a6a5636f7",
                "appliesTo": "ELEMENT",
                "styleBlockIds": []
            },
            "targets": [{
        ...
        "e-33": {
            ...
            "target": {
                "selector": ".trigger",
                "originalId": "64c3a23e8e3559214f1aeb4d|acd78df4-e23d-0186-11bd-dbd6cc54e29c",
                "appliesTo": "CLASS"
            },
            "targets": [{
                "selector": ".trigger",
    ...
    "actionLists": {
                ...
                "actionItems": [{
                    ...
                    "config": {
                        ...
                        "target": {
                            ...
                            "selector": ".img-hide",
                            "selectorGuids": ["40b72aad-88f4-434a-d8a7-e0e3a6003691"]
                        },
                        "yValue": 0,
                        "xUnit": "PX",
                        "yUnit": "%",
        ...
        "a-7": {
            ...
            "actionItemGroups": [{
                "actionItems": [{
                    ...
                    "config": {
                        ...
                        "target": {
                            "useEventTarget": "CHILDREN",
                            "selector": ".img-array-1",
                            "selectorGuids": ["902228d4-7a22-ed04-fc28-9aad9aa9fa15"]
                        },
                        "value": "block"
                    }
                }]
                ...
                "actionItems": [{
                    ...
                    "config": {
                        ...
                        "target": {
                            "useEventTarget": "CHILDREN",
                            "selector": ".img-array-2",
                            "selectorGuids": ["f0b3603d-c8f0-8a02-6329-570c7caeee98"]
                        },
                        "value": "block"
                    }
                }]
                ...
                "actionItems": [{
                    ...
                    "config": {
                        ...
                        "target": {
                            "useEventTarget": "CHILDREN",
                            "selector": ".img-array-3",
                            "selectorGuids": ["4a7fe75d-c3af-faf8-7493-e34d75a06e49"]
                        },
                        "value": "block"
                    }
                }]
            ...
            "createdOn": 1656574228333
        },
        "a-8": {
            "id": "a-8",
            "title": "Img-Array Stop",
            "actionItemGroups": [{
                "actionItems": [{
                    "id": "a-8-n-3",
                    "actionTypeId": "GENERAL_DISPLAY",
        ...
        "a-2": {
                ...
                "actionItems": [{
                    ...
                    "config": {
                        ...
                        "target": {
                            ...
                            "selectorGuids": ["e6685abf-b565-3007-6b04-2e4b395b613a"]
                        },
                        "value": 0.5,
                        "unit": ""
                    }
            ...
            "useFirstGroupAsInitialState": true,
            "createdOn": 1656571886161
        },
        "a-3": {
            "id": "a-3",
            "title": "Hover-Out (Text Opacity)",
            "actionItemGroups": [{
                "actionItems": [{
                    "id": "a-3-n",
                    "actionTypeId": "STYLE_OPACITY",
            ...
            "actionItemGroups": [{
                "actionItems": [{
                    ...
                    "config": {
                        ...
                        "duration": 500,
                        "target": {
                            "selector": ".text.project-hover.next-p",
                            "selectorGuids": ["fd4f2dd5-0f13-3e21-e92c-ffbd69a02bf0", "40851804-e332-9450-a842-d5c0fefbca99", "dadea5b2-705b-d88c-1f7b-b82073fd25de"]
                        },
                        "yValue": 100,
                        "xUnit": "PX",
                        "yUnit": "%",
                    ...
                    "config": {
                        ...
                        "target": {
                            "selector": ".cursor",
                            "selectorGuids": ["18d30e36-3afc-2aef-fb6c-c182fe0a7daf"]
                        },
                        "widthValue": 2.7,
                        "widthUnit": "em",
                        "heightUnit": "PX",
                ...
                "actionItems": [{
                    ...
                    "config": {
                        ...
                        "target": {
                            ...
                            "selector": ".loader_progress-wrapper",
                            "selectorGuids": ["980fd69b-4a9a-a638-c93b-85cae5a257fd"]
                        },
                        "yValue": -100,
                        "xUnit": "PX",
                        "yUnit": "%",
                    ...
                    "config": {
                        ...
                        "target": {
                            "useEventTarget": "SIBLINGS",
                            "selector": ".loader_numbers-wrapper",
                            "selectorGuids": ["d8f96146-2e65-9a07-7621-cc0eefec735a"]
                        },
                        "yValue": 100,
                        "xUnit": "PX",
                        "yUnit": "%",
                ...
                "actionItems": [{
                    ...
                    "config": {
                        ...
                        "target": {
                            ...
                            "selectorGuids": ["7e630770-cc00-76fe-5b72-3c7fb7b544c2"]
                        },
                        "value": 0,
                        "unit": ""
                    }
